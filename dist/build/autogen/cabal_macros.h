...
/* package Vosh-0.1.0.0 */
#define VERSION_Vosh "0.1.0.0"
#define MIN_VERSION_Vosh(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Vosh-0.1.0.0-38SCbSFJ1Ye7Hk6Nlwa2TU"

#define CURRENT_PACKAGE_KEY "Vosh-0.1.0.0-38SCbSFJ1Ye7Hk6Nlwa2TU"
